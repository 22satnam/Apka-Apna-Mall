...
# This Section is made for Laptop
...
# This Section is used for Top Wear
...
def topwear(request, data=None):
	...
	if data == None :
		topwears = Product.objects.filter(category='TW')
	elif data == 'LadiesT-Shirts' or data == 'JensT-Shirts':
...
# This section is used for Bottom Wear
